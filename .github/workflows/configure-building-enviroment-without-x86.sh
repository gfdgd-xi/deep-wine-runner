...
# 修改版本号
bash .github/workflows/run-command-in-chroot.sh sed -i "'s/) UNRELEASED; urgency=medium/~$2) UNRELEASED; urgency=medium/g'" $bottlePath/deep-wine-runner-qemu-system/debian/changelog
